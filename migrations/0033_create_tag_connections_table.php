...
if (!Capsule::schema()->hasTable('tag_connections')) {
    Capsule::schema()->create('tag_connections', function (Blueprint $table) {
        ...
        $table->index(['item_idx', 'item_type', 'connection_type'], 'idx_item_connection');
