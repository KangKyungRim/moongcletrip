...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-14 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">(관리자 전용) 뭉클딜 상세 정보 수정</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">(관리자 전용) 뭉클딜 상세 정보 수정</h6>
                </nav>
                                ...
                                <div class="container">     
                                    <div class="notification">
                                        <div class="d-flex gap-3">
                                            ...
                                            <div class="pt-2">
                                                <?php 
                                                    $message = $data['stayMoongcleoffer']->custom_message;

                                                    $parts = explode(':-:', $message);

                                                    $title = !empty($parts[0]) ? $parts[0] : "뭉클러님 취향에 맞는 여행을 찾았어요!";
                                                    
                                                    $content = isset($parts[1]) && !empty($parts[1]) ? $parts[1] : "등록된 뭉클태그 추천 숙소 " . $data['partner']->partner_name . "! 드디어 발견했어요. 지금 확인해보세요! 🌟";
                                                ?>
                                    ...
                                    <div class="promotion">
                                        <div class="d-flex align-items-center gap-2 px-2">
                                            ...
                                            <div class="tag">
                                                <?= ($data['partner']->partner_category = "stay") ? "숙박" : ""; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="deal-card">
                                            <div class="thumb__wrap">
                                                <p class="thumb__img large">
                                                    <?php if (!empty($data['partner']->image_paths)) : ?>
                                                        <img src="<?= $imagePathsRating; ?>" alt="숙소 이미지">
                                                    <?php endif ?>
                                                </p>
                                                <div class="thumb__con">
                                                    <div class="thumb-badge">
                                                        최대 
                                                        <span class="d-inline-block mx-1" id="discountViewMini">
                                                            <?= round($data['stayMoongcleoffer']->discount, 1) ?>%
                                                        </span>
                                                        할인!
                                                    </div>
                                                    <img src="/assets/app/images/common/ico_heart_black.svg" alt="하트" class="like">
                                                    <p class="detail-sub">
                                                        <span><?= $data['partner']->partner_address1; ?></span>
                                                        ...
                                                        <?php endif; ?>
                                                    <p class="detail-name"><?= $data['partner']->partner_name; ?></p>
                                                </div>
                                                <div class="thumb__price">
                                                    <div>
                                                        <p class="sale-percent" id="discountView">
                                                            <?= round($data['stayMoongcleoffer']->discount, 1) ?>%
                                                        </p>
                                                        ...
                                                        <p class="sale-price">
                                                            할인가 ~ <span style="font-weight: 400; font-size: 13px;">(*박)</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="cta-button">자세히 보기</div>
                                        </div>
                                    </div>                                    
                                </div>
                            </div>
                            ...
                            <div class="bottom-navi__wrap">
                                <ul class="bottom-navi__list">
                                    <li class="navi navi-home ">
                                        <a>
                                            <img src="/assets/app/images/common/ico_home.png" alt="홈">
                                            <span>홈</span>
                                        </a>
                                    </li>
                                    <li class="navi navi-search ">
                                        <a>
                                            <img src="/assets/app/images/common/ico_search.png" alt="검색">
                                            <span>검색</span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="navi navi-community ">
                                        <a>
                                            <img src="/assets/app/images/common/ico_community.png" alt="커뮤니티">
                                            <span>커뮤니티</span>
                                        </a>
                                    </li>
                                    <li class="navi navi-mypage ">
                                        <a>
                                            <img src="/assets/app/images/common/ico_mypage.png" alt="마이">
                                            <span>마이</span>
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div class="inputFormBox w-75">
                        <div class="p-3 d-flex align-items-center justify-content-between">
                            <div class="d-inline-block">
                                <h5>공동 수요를 공략하는 매력적인 할인과 특전을 제안해 보세요!</h5>
                                <p class="text-sm mb-0">* 내용 입력 시 해당 내용이 좌측 미리 보기에 표시됩니다.</p>
                            </div>

                            <div class="d-flex justify-content-center">
                                <button class="btn bg-gradient-primary ms-2 mb-0 text-white submitForm" type="button" title="Save">저장하기</button>
                            </div>
                        </div>
                        ...
                        <div class="card p-5 overflow-hidden mb-4" style="box-shadow: none; border-radius: 40px;">
                            <div class="form-group">
                                <label class="mx-0 fs-6">
                                    <img src="/assets/manage/images/ico_mng_moongcledeal_01.png" alt="뭉클딜"> &nbsp;뭉클딜
                                </label>
                            </div>
                            ...
                            <div class="form-group my-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="mx-0 text-sm" >제안명</label>
                                ...
                                <div class="reflectionsWrap mt-3 text-sm px-1" id="moongcledeal_name_view">
                                    <?= $data['stayMoongcleoffer']->stay_moongcleoffer_title ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card p-5 overflow-hidden mb-4" style="box-shadow: none; border-radius: 40px;">
                            <div class="form-group">
                                <label class="mx-0 fs-6">
                                    <img src="/assets/manage/images/ico_mng_moongcledeal_02.png" alt="날짜"> &nbsp;날짜
                                </label>
                            </div>
                            ...
                            <div class="form-group my-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="mx-0 text-sm" >판매 기간</label>
                                ...
                                <div class="reflectionsWrap mt-3 text-sm px-1" id="moongcledeal_period">
                                    <?php if ($data['stayMoongcleoffer']->sale_start_date === null) : ?>
                                        상시
                                    <?php else : ?>
                                        <?php 
                                            $start_date = explode(' ', $data['stayMoongcleoffer']->sale_start_date)[0]; 
                                            $end_date = explode(' ', $data['stayMoongcleoffer']->sale_end_date)[0]; 
                                        ?>
                                        <?= $start_date ?> ~ <?= $end_date ?>
                                    <?php endif; ?> 
                                </div>
                            ...
                            <div class="form-group my-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="mx-0 text-sm" >투숙 가능일</label>
                                ...
                                <?php if ($data['stayMoongcleoffer']->stay_start_date === null || $data['stayMoongcleoffer']->stay_end_date === null) : ?>
                                    <div class="reflectionsWrap mt-3 text-sm px-1" id="moongcledeal_possible_view">
                                        상시
                                    </div>
                                <?php else : ?>
                                    <div class="reflectionsWrap possibleReflectionsWrap mt-3 text-sm px-1">
                                        <span class="text-sm d-inline-block fw-bold me-2">투숙 기간</span>
                                        <span class="text-sm d-inline-block" id="moongcledeal_possible">
                                            <?php 
                                                $start_date = explode(' ', $data['stayMoongcleoffer']->stay_start_date)[0]; 
                                                $end_date = explode(' ', $data['stayMoongcleoffer']->stay_end_date)[0]; 
                                            ?>
                                            <?= $start_date ?> ~ <?= $end_date ?>
                                        </span>    
                                    </div>
                                    <?php if (!empty($data['stayMoongcleoffer']->blackout_dates)) : ?>    
                                        <div class="reflectionsWrap possibleReflectionsWrap mt-1 text-sm px-1">
                                            <span class="text-sm d-inline-block fw-bold me-2">제외 날짜</span> 
                                            <span class="text-sm d-inline-block" id="mooongcledeal_blackout">
                                                <?= implode(', ', $data['stayMoongcleoffer']->blackout_dates); ?>
                                            </span>
                                        </div>
                                    <?php else : ?>
                                        <div class="reflectionsWrap possibleReflectionsWrap mt-1 text-sm px-1"></div>
                                    <?php endif; ?>
                                <?php endif; ?> 
                                ...
                                <div class="reflectionsWrap possibleReflectionsWrap mt-1 text-sm px-1"  style="display: none;">
                                    <span class="text-sm d-inline-block fw-bold me-2">제외 날짜</span> 
                                    <span class="text-sm d-inline-block" id="mooongcledeal_blackout"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card p-5 overflow-hidden mb-4" style="box-shadow: none; border-radius: 40px;">
                            <div class="form-group">
                                <label class="mx-0 fs-6">
                                    <img src="/assets/manage/images/ico_mng_moongcledeal_03.png" alt="단독 제안"> &nbsp;단독 제안
                                </label>
                            </div>
                            ...
                            <div class="form-group my-3"> 
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="mx-0 text-sm" ><b class="text-danger">*</b> 포함 혜택</label>
                                ...
                                <div class="reflectionsWrap mt-3 text-sm px-1">
                                    <div id="moongcledeal_discount_view" style="<?= $data['stayMoongcleoffer']->discount == "0.00" ? "display: none;" : "display: block;"; ?>">
                                        <?= round($data['stayMoongcleoffer']->discount, 1) ?>% 할인
                                    </div>
                            ...
                            <div class="form-group my-3"> 
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="mx-0 text-sm" >기반 요금제</label>
                                    <button type="button" class="bg-white text-sm" style="color: #cb0c9f; border: 0px;" onclick="alert('기반 요금제는 수정할 수 없습니다.');">
                                        <i class="fa-solid fa-pen"></i> &nbsp;수정
                                    </button>
                                </div>
                                <div class="reflectionsWrap mt-3 text-sm px-1" id="moongcledeal_rateplan"></div>
                            </div>                        
                            
                            <div class="form-group my-3"> 
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="mx-0 text-sm" >적용 객실</label>
                            ...
                            <div class="form-group my-3"> 
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <label class="mx-0 text-sm" ><b class="text-danger">*</b> 수요 공략 태그</label>
                                        <button 
                                            type="button" 
                                            style="background: none; border: 0px;" 
                                            data-bs-toggle="tooltip" 
                                            data-bs-placement="bottom" 
                                            title="다양하고 정확한 수요 공략 태그를 선택하면 많은 고객에게 매칭됩니다. 연관되지 않은 태그를 무분별하게 선택 시에는 효과가 떨어질 수 있어요.">
                            ...
                            <div class="form-group my-3"> 
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <label class="mx-0 text-sm" >대표 태그</label>
                                    </div>
                                    <button type="button" class="bg-white text-sm" style="color: #cb0c9f; border: 0px;" data-bs-toggle="modal" data-bs-target="#moongcledeal_curated_tag_modal">
                                        <i class="fa-solid fa-pen"></i> &nbsp;수정
                                    </button>
                                </div>
                                <div class="reflectionsWrap mt-3 text-sm px-1" id="moongcledeal_curated_tag_view" style="display: none;"></div>    
                            </div>
                        </div>
                        ...
                        <div class="card p-5 overflow-hidden mb-4" style="box-shadow: none; border-radius: 40px;">
                            <div class="form-group">
                                <label class="mx-0 fs-6">
                                    <img src="/assets/manage/images/ico_mng_moongcledeal_04.png" alt="알림"> &nbsp; 알림
                                </label>
                            </div>
                            ...
                            <div class="form-group my-3"> 
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="mx-0 text-sm" >발송 대상</label>
                            ...
                            <div class="form-group my-3"> 
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="mx-0 text-sm" >무료 푸시 메시지</label>
                        ...
                        <div class="card p-5 overflow-hidden" style="box-shadow: none; border-radius: 40px;">
                            <div class="form-group">
                                <label class="mx-0 fs-6">
                                    <img src="/assets/manage/images/ico_mng_moongcledeal_07.png" alt="매력도"> &nbsp;뭉클딜 매력도
                                </label>
                            </div>
                            ...
                            <div class="form-group my-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    <label class="mx-0 text-sm">지수</label>
                                    <button type="button" class="bg-white text-sm" style="color: #cb0c9f; border: 0px;" data-bs-toggle="modal" data-bs-target="#moongcledeal_attractive_modal">
                                        <i class="fa-solid fa-pen"></i> &nbsp;수정
                                    </button>
                                </div>
                                <div class="reflectionsWrap mt-3 text-sm px-1 pe-0 d-inline-block" id="moongcledeal_attractive_view">
                                    <?= $data['stayMoongcleoffer']->attractive; ?>
                                </div>
                                <span class="text-sm mt-3 d-inline-block">점</span>
                            </div>
                        </div>

                        <div class="d-flex justify-content-center mt-4">
                            <button type="button" id="cancelForm" name="cancelForm" class="btn btn-light m-0" onclick="location.href='/manage/moongcleoffers/operate'">취소</button>
                            <button class="btn bg-gradient-primary ms-2 mb-0 text-white submitForm" type="button" title="Save">저장하기</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-m" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-6" id="exampleModalLabel">뭉클딜 제안명</h5>
                        ...
                        <div class="card card-plain">
                            <div class="card-body">
                                <div class="form-group mb-0">
                                    <input 
                                        type="text" 
                                        id="moongcledeal_name" 
                                        value="<?= $data['stayMoongcleoffer']->stay_moongcleoffer_title ?>"
                                        data-target="#moongcledeal_name_view" 
                                        class="form-control" 
                                        placeholder="고객님께 노출되는 매력적인 뭉클딜명을 설정해 보세요"
                                        maxlength="100">
                                    <span class="d-block text-xs mt-2 px-1">예시) [단독] 30% 할인+2인 삼다정 조식뷔페 무료 제안+레이트체크아웃 2시간 무료</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-link mr-auto mb-0" data-bs-dismiss="modal">닫기</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="moongcledeal_period_modal" tabindex="-1" role="dialog" aria-labelledby="moongcledeal_period_modal">
            <div class="modal-dialog modal-dialog-centered modal-m" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-6" id="exampleModalLabel">판매 기간</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span>×</span>
                        </button>
                    </div>
                        ...
                        <div class="card card-plain">
                            <div class="card-body">
                                <div class="form-check">
                                    <input type="radio" id="allTime" class="form-check-input" name="period" data-target="#moongcledeal_period" data-name="상시"
                                    <?= $data['stayMoongcleoffer']->sale_start_date === null ? "checked" : "";  ?>>
                                ...
                                <div class="d-flex align-items-center gap-20px">
                                    ...
                                    <div class="dateSelectBox periodDateSelectBox form-group mb-0 w-100" style="display: <?= $data['stayMoongcleoffer']->sale_start_date !== null ? 'block' : 'none'; ?>">
                                        <input
                                            id="period-date"
                                            type="text"
                                            ...
                                            placeholder="탭하여 날짜 선택"
                                            style="color: #cb0c9f;"
                                            value="<?= $data['stayMoongcleoffer']->sale_start_date !== null 
                                                ? date('Y-m-d', strtotime($data['stayMoongcleoffer']->sale_start_date)) . ' ~ ' . date('Y-m-d', strtotime($data['stayMoongcleoffer']->sale_end_date)) 
                                                : ''; ?>">
                                    </div>
                                </div> 
                            </div>
        ...
        <div class="modal fade" id="moongcledeal_possible_modal" tabindex="-1" role="dialog" aria-labelledby="moongcledeal_possible_modal" >
            <div class="modal-dialog modal-dialog-centered modal-m" role="document" style="max-width: 60rem;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-6" id="exampleModalLabel">투숙 가능일</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span>×</span>
                        </button>
                    </div>
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            <div class="card-body">
                                <div class="form-check">
                                    <input type="radio" id="possibleAllTime" class="form-check-input" name="possible" data-target="#moongcledeal_possible_view" data-name="상시"
                                    <?= $data['stayMoongcleoffer']->stay_start_date === null ? "checked" : "";  ?>>
                                ...
                                <div class="form-check">
                                    ...
                                    <?= $data['stayMoongcleoffer']->stay_start_date !== null ? "checked" : "";  ?>>
                                    <label for="possibleSelectDate" class="custom-control-label">날짜 선택</label>
                                    <?php 
                                    $start_date = $data['stayMoongcleoffer']->stay_start_date !== null 
                                        ? date('Y-m-d', strtotime($data['stayMoongcleoffer']->stay_start_date)) 
                                        : null;
                                    $end_date = $data['stayMoongcleoffer']->stay_end_date !== null
                                        ? date('Y-m-d', strtotime($data['stayMoongcleoffer']->stay_end_date)) 
                                        : null;
                                    ?>

                                    <?php if ($start_date && $end_date) : ?>
                                        <div class="reflectionsWrap ms-2 text-sm" id="moongcledeal_possible_modal_view" style="color: #cb0c9f; display: inline-block;">
                                            <?= $start_date . ' ~ ' . $end_date ?>
                                        </div>
                                    <?php else : ?>
                                ...
                                <div class="possibleSelectBox mt-4" style="display: <?= $data['stayMoongcleoffer']->stay_start_date !== null ? 'block' : 'none'; ?>">
                                    <div class="calendarBox w-100">
                                        <div>
                                            <div class="dateSelectBox possibleDateSelectBox form-group mb-0" style="display: <?= $data['stayMoongcleoffer']->stay_start_date !== null ? 'block' : 'none'; ?>">                                            
                                                <input 
                                                    id="possible-date"
                                                    type="text"
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <?php 
                                            $stayStartDate = isset($data['stayMoongcleoffer']->stay_start_date) ? trim($data['stayMoongcleoffer']->stay_start_date) : '';
                                            $stayEndDate = isset($data['stayMoongcleoffer']->stay_end_date) ? trim($data['stayMoongcleoffer']->stay_end_date) : '';
                                            $blackoutDates = $data['stayMoongcleoffer']->blackout_dates; 

                                            $isDisabled = empty($stayStartDate) || empty($stayEndDate) ? 'disabled' : '';
                                            $isChecked = (is_array($blackoutDates) && count($blackoutDates) > 0) ? 'checked' : '';
                                            
                                            // blackout_dates가 있으면 쉼표로 구분하여 출력
                                            $blackoutDatesString = '';
                                            if (is_array($blackoutDates) && count($blackoutDates) > 0) {
                                                $blackoutDatesString = implode(', ', $blackoutDates); // 쉼표로 구분
                                            }
                                        ?>
                                        <div class="form-check">
                                            <input type="checkbox" id="blackout" class="form-check-input" <?= $isDisabled ?> <?= $isChecked ?>>
                                            <label for="blackout" class="custom-control-label">제외 날짜 지정</label>
                                            <?php if ($blackoutDatesString) : ?>
                                                <div class="reflectionsWrap d-inline-block ms-2 text-sm" id="moongcledeal_blackout_modal_view" style="color: #cb0c9f;">
                                                    <?= $blackoutDatesString ?>
                                                </div>
                                            <?php else : ?>
                                        ...
                                        <div class="calendarBox w-100 blackoutCalendar mt-4" style="display: <?= $blackoutDates ? "block" : "none" ?>;">
                                            <div>
        ...
        <div class="modal fade" id="moongcledeal_benefit_modal" tabindex="-1" role="dialog" aria-labelledby="moongcledeal_benefit_modal">
            <div class="modal-dialog modal-dialog-centered modal-m" role="document" style="max-width: 55%;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-6" id="exampleModalLabel">포함 혜택</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span>×</span>
                        </button>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap">
                                    <div class="w-100">
                                        ...
                                        <label for="benefitInput" class="custom-control-label">할인율</label>
                                    </div>
                                    <div class="w-100 form-group mb-0">
                                        <input      
                                            ...
                                            placeholder="0"
                                            value="<?= round($data['stayMoongcleoffer']->discount, 1) ?>"
                                            min="5"
                                            max="100"
                                            onkeydown="blockNegative(event);"
                                            style="display: inline-block; border: 1px solid #dee2e6;">
                                            <span class="d-inline-block text-sm">% 할인</span>
                                            <p class="mb-4 text-sm">( 요금 관리 > 상시 할인과 중복 할인되지 않습니다. 상시 할인이 설정되어 있더라도 할인 전 '일반 요금' 기준에 적용됩니다. )</p>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap">
                                    <div class="w-100">
                                        ...
                                        <label for="benefitInput" class="custom-control-label">특전 제안 (직접 입력)</label>
                                    </div>
                                    <div class="d-flex w-100 form-group my-3 align-items-center justify-content-between" style=" border: 1px solid #dee2e6; border-radius: 0.5rem;">
                                        <input      
                                            ...
                                            placeholder="제안하려는 혜택을 직접 입력해 보세요"
                                ...
                                <div class="d-flex flex-wrap">
                                    <div class="w-100">
                                        ...
                                        <label for="benefitChoice" class="custom-control-label">특전 제안 (선택 입력)</label>
                                    </div>
        ...
        <div class="modal fade" id="moongcledeal_rateplan_modal" tabindex="-1" role="dialog" aria-labelledby="moongcledeal_rateplan_modal">
            <div class="modal-dialog modal-dialog-centered modal-m" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    <h5 class="modal-title fs-6" id="exampleModalLabel">기반 요금제</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span>×</span>
                        </button>
                    </div>
                                ...
                                <?php foreach ($data['rateplans'] as $index => $rateplan) : ?>
                                    <div class="form-check">
                                        <input 
                                            ...
                                            <?= $rateplan->rateplan_idx === $data['stayMoongcleoffer']->rateplan_idx ? 'checked' : '' ;?>>
        ...
        <!-- 적용 객실 -->
        <div class="modal fade" id="moongcledeal_room_modal" tabindex="-1" role="dialog" aria-labelledby="moongcledeal_room_modal">
            <div class="modal-dialog modal-dialog-centered modal-m" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-6" id="exampleModalLabel">적용 객실</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span>×</span>
                        </button>
                    </div>
        ...
        <div class="modal fade" id="moongcledeal_tag_modal" tabindex="-1" role="dialog" aria-labelledby="moongcledeal_tag_modal">
            <div class="modal-dialog modal-dialog-centered modal-m" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-6" id="exampleModalLabel">수요 공략 태그</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span>×</span>
                        </button>
                    </div>
                        ...
                        <div class="card card-plain">
                            <div class="card-body">
                                <div class="d-flex flex-wrap">
                                    <div class="w-100">
                                        <i class="fa-solid fa-check"></i>
                                        <label for="benefitChoice" class="custom-control-label">선택</label>
                                    </div>
                                    <div class="w-100 mt-3 p-2 py-3" style="border: 1px solid #dee2e6; border-radius: 10px;">
                                        <!-- tab -->
        ...
        <!-- 대표 태그 -->
        <div class="modal fade" id="moongcledeal_curated_tag_modal" tabindex="-1" role="dialog" aria-labelledby="moongcledeal_curated_tag_modal">
            <div class="modal-dialog modal-dialog-centered modal-m" role="document" style="max-width: 55%;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-6">대표 태그</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span>×</span>
                        </button>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="w-100 mt-3 p-2 py-3" style="border: 1px solid #dee2e6; border-radius: 10px;">
                                        ...
                                        <!-- content -->
                                         <div class="tab-content tabChoice p-3">
                                            <div class="tab-pane curatedAllTag fade show active" id="companionTags" role="tabpanel" aria-labelledby="nav-basic-tab">
                                                <ul class="curatedAllTag_container">
                                                    <?php 
                                                    $replaceTag = [
                                                        "커플" => "연인과",
                                                        "가족" => "가족과"
                                                    ...
                                                    $shownTags = []; // 이미 출력한 태그 담을 배열

                                                    foreach ($data['curatedAllTags'] as $curatedAllTag) : 
                                                        $tagName = $curatedAllTag['tag_name'];

                                                        if (array_key_exists($tagName, $replaceTag)) {
                                                            $tagName = $replaceTag[$tagName];
                                                        }

                                                        if (in_array($tagName, $shownTags)) {
                                                            continue; // 이미 출력된 워딩이면 스킵
                                                        }

                                                        $shownTags[] = $tagName;
                                                    ?>
                                                        <li class="text-sm d-inline-block" data-name="<?= $curatedAllTag['tag_machine_name']; ?>">
                                                            <span class="d-inline-block py-1 px-4">
                                                                <?= $tagName; ?>
                                                            </span>
                                                        </li>
                                                    <?php endforeach; ?>
        ...
        <div class="modal fade" id="moongcledeal_target_modal" tabindex="-1" role="dialog" aria-labelledby="moongcledeal_target_modal">
            <div class="modal-dialog modal-dialog-centered modal-m" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-6" id="exampleModalLabel">발송 대상</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span>×</span>
                        </button>
                    </div>
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            <div class="card-body">
                                <div class="form-check">
                                    <input type="radio" id="push_only" class="form-check-input" name="target" data-target="#moongcledeal_target" data-name="수요 매칭 고객에게 발송"
                                        <?= $data['stayMoongcleoffer']->audience === "push_only" ? "checked" : ""; ?>>
                                    <label for="push_only" class="custom-control-label">
                                        수요 매칭 고객에게 발송
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="all" class="form-check-input" name="target" data-target="#moongcledeal_target" data-name="전체 발송 (수요 매칭 고객 + 탐색 고객)"
                                        <?= $data['stayMoongcleoffer']->audience === "all" ? "checked" : ""; ?>>
                                    <label for="all" class="custom-control-label">
                                        전체 발송 (수요 매칭 고객 + 탐색 고객)
                                    </label>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="moongcledeal_text_modal" tabindex="-1" role="dialog" aria-labelledby="moongcledeal_text_modal">
            <div class="modal-dialog modal-dialog-centered modal-m" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-6" id="exampleModalLabel">무료 푸시 메시지</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span>×</span>
                        </button>
                    </div>
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            <div class="card-body">
                                <div class="form-check">
                                    <input type="radio" id="basic" class="form-check-input" name="notiText" data-name="뭉클 시스템에서 알아서 메시지 발송"
                                    <?= $data['stayMoongcleoffer']->custom_message === null ? "checked" : ""; ?>>
                                ...
                                <div class="form-group mb-0 mt-3 textareaBox" style="display: none;">
                                    <input 
                                        ...
                                        placeholder="알림 타이틀을 입력해 주세요">
                                    <textarea 
                                        class="form-control" 
                                        id="customMessage" 
                                        name="customMessage" 
                                        rows="7" 
                                        placeholder="알림 메시지를 입력해 주세요" 
        ...
        <!-- 매력도 지수 -->
        <div class="modal fade" id="moongcledeal_attractive_modal" tabindex="-1" role="dialog" aria-labelledby="#moongcledeal_attractive_modal">
            <div class="modal-dialog modal-dialog-centered modal-m" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-6">매력도 지수</h5>
                        <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                            <span>×</span>
                        </button>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="form-group mb-0">
                                    <input 
                                        ...
                                        min="0"
                                        max="100" 
                                        id="moongcledeal_attractive" 
                                        value="<?= $data['stayMoongcleoffer']->attractive; ?>"
                                        data-target="#moongcledeal_attractive_view" 
                                        class="form-control d-inline-block w-30" 
                                        placeholder="0">
                                    <label for="moongcledeal_attractive" class="fw-normal text-sm">점</label>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).on("change", 'input[name="period"]', function () {
            const isSelectDateChecked = $("#selectDate").is(":checked");
            ...
            if (isSelectDateChecked) {
                ...
                if (window.flatpickrInstanceModal1) {
                    ...
                    window.flatpickrInstanceModal1 = null;
                }
            }
       ...
       // 투숙 가능일
        $(document).ready(function() {
            $('input[name="possible"]').on("change", function () {
                ...
                if (periodName === "상시") {
                    reflectionsWrap.text("상시");
                } 
            });
        });

         // 기존 데이터 
         const existingBenefits = <?= json_encode($data['stayMoongcleoffer']->benefits ?? []); ?>;

        // benefitsTextArray에 기존 데이터 추가
        const benefitsTextArray = [...existingBenefits];
        ...
        $(document).on("change", 'input[name="discount"]', function () {
            ...
            let inputValue = `${discountValue}% 할인`;

            $discountWrap.text(inputValue);
            $discountView.text(`${discountValue}%`);
            $discountViewMini.text(`${discountValue}%`);

            let $discountItem = $benefitList.find(".discount.benefit-list-item");

            if (Number(discountValue) !== 0) {
                if ($discountItem.length) {
                    $discountItem.text(inputValue);
                } else {
                    $benefitList.prepend(`<li class="discount benefit-list-item">${inputValue}</li>`);
                }
            } else { 
                $discountItem.remove();
            }
        ...
        $(document).ready(function () {
            const $benefitView = $("#moongcledeal_benefit_view");
            const $benefitList = $("#moongcledeal_benefit");
            const $previewWrap = $(".benefitPreviewWrap");

            existingBenefits.forEach(benefit => {

                if (benefit.includes("% 할인")) {
                    $benefitList.append(`<li class="discount benefit-list-item">${benefit}</li>`);
                } else {
                    $benefitList.append(`<li class="benefit-list-item">${benefit}</li>`);
                }

                if ($benefitView.length && /^[0-9]+% 할인$/.test(benefit.trim())) {
                    return;
                }

                const newBenefit = $(`
                    <div class="d-inline-block py-1 px-4 benefit-item" style="border-radius: 100px; border: 1px solid #ededed;">
                        <span class="d-inline-block text-sm">${benefit}</span>
                        <button type="button" class="remove-benefit" style="background: none; border: 0px; color: #959595;">
                            <i class="fa-solid fa-circle-xmark"></i>
                        </button>
                    </div>
                `);
                $previewWrap.append(newBenefit).show();

                if ($benefitView.is(":hidden")) {
                    $benefitView.text(benefit).show();
                } else {
                    $benefitView.append($benefitView.text() ? " | " + benefit : benefit);
                }

                $(".tab-pane.benefit ul li").each(function () {
                    if ($(this).find("span").text().trim() === benefit) {
        ...
        function displayRooms($rateplan) {
            ...
            const checkedRoomIds = <?= json_encode($data['stayMoongcleoffer']->rooms ?? []); ?>;
            const selectedRooms = checkedRoomIds.map(id => rooms.find(room => room.room_idx === id)?.room_name).filter(Boolean);

            rooms.forEach(function(room) {
                if (room.room_rateplan_status !== 'notExist') {
                    const isChecked = checkedRoomIds.includes(room.room_idx);

                    const roomHtml = `
                        <div class="form-check">
                            <input type="checkbox" id="room-${room.room_idx}" class="form-check-input" name="room" data-name="${room.room_name}" data-target="#moongcledeal_room" ${isChecked ? 'checked' : ''}>
        ...
        $(document).on("change", 'input[name="room"]', function () {
            ...
            if (roomName) {
                if ($(this).is(":checked")) {
                    if (reflectionsWrap.is(":hidden")) {
                        reflectionsWrap.text(roomName).show();
                    } else {
                        reflectionsWrap.append(reflectionsWrap.text() ? " | " + roomName : roomName);
                    }
                } else {
                    let currentText = reflectionsWrap.text();
                    let updatedText = currentText.split(" | ").filter(item => item.trim() !== roomName).join(" | ").trim();

                    if (updatedText) {
                        reflectionsWrap.text(updatedText);
                    } else {
                        reflectionsWrap.text(""); 
                        reflectionsWrap.hide(); 
                    }
                }

                if (reflectionsWrap.text().trim()) {
                    reflectionsWrap.show();
                }
            }
        });
        ...
        // 기존 선택된 태그 데이터
        const existingTags = <?= json_encode($data['stayMoongcleoffer']->tags ?? []); ?>;

        // tagsTextArray에 기존 데이터 추가
        const tagsTextArray = [...existingTags];

        // 페이지 로딩 시 이미 선택된 태그를 표시
        $(document).ready(function() {
            tagsTextArray.forEach(function(tagMachineName) {
                const $tagItem = $(".tab-pane.relatedTag ul li[data-name='" + tagMachineName + "']");
                if ($tagItem.length) {
                    const tagText = $tagItem.find('span').text().trim();  
                    ...
                    if ($tagView.is(":hidden")) {
                        ...
                        $tagView.append($tagView.text() ? " " + "#" + tagText : "#" + tagText);
                    }

                    $tagList.append(`
                        <span class="d-inline-block tag-list-item">#${tagText}</span>
                    `);
        ...
        // 기존 선택된 대표 태그 데이터
        const existingcuratedTags = <?= json_encode($data['stayMoongcleoffer']->curated_tags ?? []); ?>;

        // tagsTextArray에 기존 데이터 추가
        const curatedTagsTextArray = [...existingcuratedTags];

        // 페이지 로딩 시 이미 선택된 태그를 표시
        $(document).ready(function() {
            curatedTagsTextArray.forEach(function(curatedTagMachineName) {
                const $curatedTagItem = $(".tab-pane.curatedAllTag ul li[data-name='" + curatedTagMachineName + "']");
                if ($curatedTagItem.length) {
                    const curatedTagText = $curatedTagItem.find('span').text().trim();  
                    const $curatedTagView = $("#moongcledeal_curated_tag_view");

                    // 태그를 표시하고 추가
                    if ($curatedTagView.is(":hidden")) {
                        $curatedTagView.text("#" + curatedTagText).show(); 
                    } else {
                        $curatedTagView.append($curatedTagView.text() ? " " + "#" + curatedTagText : "#" + curatedTagText);
                    }

                    $curatedTagItem.addClass('active'); 
                }
            });
        });

        // 대표 태그 선택
        $(document).on("click", ".tab-pane.curatedAllTag ul li", function (e) {
            const curatedTagMachineName = $(this).data("name");
            const curatedTagText = $(this).find('span').text().trim();  
            const $curatedTagView = $("#moongcledeal_curated_tag_view");

            if ($(this).hasClass('active')) {  
                let curatedCurrentText = $curatedTagView.text()
                    .replace(new RegExp("(?:^|\\s)#" + curatedTagText.replace(/[.*+?^${}()|[\]\\]/g, "\\$&") + "(?=\\s|$)", "g"), "")
                    .trim();
                    
                if (!curatedCurrentText) $curatedTagView.hide(); 
                else $curatedTagView.text(curatedCurrentText);

                const curatedIndex = curatedTagsTextArray.indexOf(curatedTagMachineName);
                if (curatedIndex !== -1) {
                    curatedTagsTextArray.splice(curatedIndex, 1);
                }
                ...
                curatedTagsTextArray.push(curatedTagMachineName);
        ...
        $(document).on("change", 'input[name="target"]', function () {
         ...
         // 무료 푸시 메시지 
         $(document).ready(function() {
            const isCustom = '<?= $data['stayMoongcleoffer']->custom_message ?>' !== '';

            if (isCustom) {
                $('#custom').prop('checked', true);

                const title = '<?= $data['stayMoongcleoffer']->custom_message ? explode(':-:', $data['stayMoongcleoffer']->custom_message)[0] : '' ?>';
                const content = '<?= $data['stayMoongcleoffer']->custom_message ? explode(':-:', $data['stayMoongcleoffer']->custom_message)[1] : '' ?>';

                $("#customTitle").val(title);
                $("#customMessage").val(content);

                $("#moongcledeal_customTitle_view").text(title);
                $("#moongcledeal_customMessage_view").text(content);

                $(".textareaBox").show();
            } else {
                $('#basic').prop('checked', true);

                $(".notiReflectionsWrap").text("뭉클 시스템에서 알아서 메시지 발송");
            ...
            $(document).on("change", 'input[name="notiText"]', function () {
                ...
                if (isCustom) {
                    $(".textareaBox").show();
                    $(".notiReflectionsWrap").text("").show();

                    $("#moongcledeal_customTitle_view").text($("#customTitle").val());
                    $("#moongcledeal_customMessage_view").text($("#customMessage").val());
                } else {
                    $(".textareaBox").hide();
                    $(".notiReflectionsWrap").text("뭉클 시스템에서 알아서 메시지 발송").show();

                    $("#customTitle, #customMessage").val("");
                    $("#moongcledeal_customTitle_view").text("");
                    $("#moongcledeal_customMessage_view").text("");

                    $("#moongcledeal_customTitle").text("뭉클러님 취향에 맞는 여행을 찾았어요!");
                    $("#moongcledeal_customMessage").text(`등록된 뭉클태그 추천 숙소 <?= $data['partner']->partner_name; ?>! 드디어 발견했어요. 지금 확인해보세요! 🌟`);
                }
            });
    ...
    <script>
        ...
        var saleStartDate = "<?= $data['stayMoongcleoffer']->sale_start_date ?? '' ?>";
        var saleEndDate = "<?= $data['stayMoongcleoffer']->sale_end_date ?? '' ?>";

        var startDate = saleStartDate ? new Date(saleStartDate) : null;
        var endDate = saleEndDate ? new Date(saleEndDate) : null;

        function initPeriodFlatpickr() {
            if (window.flatpickrInstanceModal1) {
                window.flatpickrInstanceModal1.destroy();
            }
            ...
            window.flatpickrInstanceModal1 = flatpickr(periodModalSelector, {
                ...
                dateFormat: "Y-m-d",
                defaultDate: startDate ? [startDate, endDate] : [],
                locale: 'ko',
        ...
        <?php if (isset($data['stayMoongcleoffer']->blackout_dates) && is_array($data['stayMoongcleoffer']->blackout_dates)) : ?>
            selectedBlackout = <?php echo json_encode($data['stayMoongcleoffer']->blackout_dates); ?>;
        <?php endif; ?>
        ...
        window.flatpickrInstanceModal3 = flatpickr(blackoutSelector, {
            ...
            monthSelectorType: 'static',
            dateFormat: "Y-m-d", 
            defaultDate: selectedBlackout.length > 0 ? selectedBlackout : null,
            locale: 'ko',
            onReady: function(selectedDates, dateStr, instance) {
                removeTodayClass(instance);
                ...
                if (stayStartDate && stayEndDate) {
                    ...
                    if (window.flatpickrInstanceModal3) {
                        window.flatpickrInstanceModal3.set('minDate', stayStartDate);
                        window.flatpickrInstanceModal3.set('maxDate', stayEndDate);
                    }
                }
            },
            onChange: function(selectedDates, dateStr, instance) {
        ...
        // 받아온 날짜 값
        var stayStartDate = "<?= isset($data['stayMoongcleoffer']->stay_start_date) ? date('Y-m-d', strtotime($data['stayMoongcleoffer']->stay_start_date)) : '' ?>";
        var stayEndDate = "<?= isset($data['stayMoongcleoffer']->stay_end_date) ? date('Y-m-d', strtotime($data['stayMoongcleoffer']->stay_end_date)) : '' ?>";
        ...
        window.flatpickrInstanceModal2 = flatpickr(possibleModalSelector, {
            ...
            monthSelectorType: 'static',
            dateFormat: "Y-m-d", 
            defaultDate: stayStartDate && stayEndDate ? [stayStartDate, stayEndDate] : null,
            locale: 'ko',
            onReady: function(selectedDates, dateStr, instance) {
                removeTodayClass(instance);
        ...
        if (stayStartDate && stayEndDate) {
            selectedPossible.startDate = new Date(stayStartDate);
            selectedPossible.endDate = new Date(stayEndDate);
        }
    </script>

    <script>
         // 저장 함수
         const submitMoongcleOffer = async () => {
            ...
            if (customRadio.checked) {
                ...
                if (!customTitle || !customMessage) {
                    alert("알림 타이틀과 메시지를 모두 입력해 주세요.");
                    return; 
                }
            }

            const existingDiscountIndex = benefitsTextArray.findIndex(benefit => benefit.includes("% 할인"));
            if (existingDiscountIndex !== -1) {
                // 기존 할인율을 제거
                benefitsTextArray.splice(existingDiscountIndex, 1);
            }
            
            // 새로운 할인율을 추가 (할인율이 0보다 크면)
            if (discountRate > 0) {
                benefitsTextArray.unshift(`${discountRate}% 할인`);
            }

            const formData = {
                partnerIdx: Number(<?php echo json_encode($data['partner']->partner_idx); ?>), // index
                moongcleoffer: {
                    stayMoongcleofferIdx: <?php echo json_encode($data['stayMoongcleoffer']->stay_moongcleoffer_idx ); ?>, // 뭉클오퍼 index
                    title: document.getElementById('moongcledeal_name')?.value || "", // 뭉클딜 제안명
                    rateplanIdx: Number(document.querySelector('input[name="rateplan"]:checked')?.id || ''), // 선택된 기반 요금제
                    saleStartDate: formatDate(selectedPeriod.startDate), // 판매 기간 시작일
                    saleEndDate: formatDate(selectedPeriod.endDate), // 판매 기간 마감일
                    stayStartDate: formatDate(selectedPossible.startDate), // 투숙 가능 기간 시작일
                    stayEndDate: formatDate(selectedPossible.endDate), // 투숙 가능 기간 마감일
                    blackoutDates: selectedBlackout, // 제외 날짜
                    discountRate: Number(document.getElementById('discount').value), // 할인율 %
                    benefits: benefitsTextArray, // 포함 혜택
                    rooms: [], // 적용 객실
                    tags: [ ...tagsTextArray ], // 수요 공략 태그
                    audience: document.querySelector('input[name="target"]:checked')?.id, // 발송 대상
                    customTitle: document.getElementById('customTitle')?.value || "", // 무료 푸시 메시지 타이틀
                    customMessage:document.getElementById('customMessage')?.value || "" , // 무료 푸시 메시지 텍스트
                    curatedTags: [ ...curatedTagsTextArray ],// 대표 태그,
                    attractive: Number(document.getElementById('moongcledeal_attractive')?.value)// 매력도 지수
                },
                operate: true
            }            
            ...
            try {
                // 서버로 POST 요청
                const response = await fetch('/api/partner/edit-moongcleoffer', {
                    method: 'POST',
                    headers: {
                ...
                console.error('뭉클딜 수정 중 오류 발생:', error);
                alert('뭉클딜 수정 중 오류가 발생했습니다.');
            }
        };
    </script>
    ...
    <script>
        ...
        document.querySelectorAll('.submitForm').forEach(button => {
            button.addEventListener('click', async function (e) {
                ...
                const { ok, result } = await submitMoongcleOffer();

                if (ok) {
                    alert('뭉클딜 수정이 완료되었습니다.');
                    loading.style.display = 'flex';
                    window.location.reload();
                } else {
                    alert(result?.error || '뭉클딜 수정 중 문제가 발생했습니다.');
                }
