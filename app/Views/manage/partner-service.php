                        ...
                        <div class="card-header pb-0 mb-5">
                            <div class="d-lg-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex justify-content-end align-items-center">
                                    ...
                                    <a 
                                        href="<?= count($partnerServices) >= 4 ? 'javascript:void(0);' : '/manage/partner-service-create' ?>" 
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-weight-bold my-2 text-xs">
                                                    <div class="cursor-pointer">
                                                        <a href="/manage/partner-service-edit?serviceDetailIdx=<?= $partnerService->service_detail_idx; ?>">
