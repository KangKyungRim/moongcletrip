...
<body class="g-sidenav-show  bg-gray-100">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-14 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">신규 뭉클딜 생성</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">신규 뭉클딜 생성</h6>
                </nav>
                                            ...
                                            <div class="thumb__wrap">
                                                ...
                                                <div class="thumb__gift">
                                                    <ul id="moongcledeal_benefit">
                                                        <!-- 포함 혜택 추가 영역 -->
                                                        <li class="benefit-list-item defaultDiscount">5% 할인</li>
                                                    </ul>
                                                </div>
                                            </div>
                        ...
                        <div class="card p-5 overflow-hidden mb-4" style="box-shadow: none; border-radius: 40px;">
                            ...
                            <div class="form-group my-3">
                                ...
                                <div class="reflectionsWrap possibleReflectionsWrap mt-1 text-sm px-1" style="display: none;">
                                    ...
                                    <span class="text-sm d-inline-block" id="mooongcledeal_blackout">없음</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-plain">
                            <div class="card-body">
                                <div class="form-group mb-0">
                                    <input type="text" id="moongcledeal_name" data-target="#moongcledeal_name_view" class="form-control" placeholder="고객님께 노출되는 매력적인 뭉클딜명을 설정해 보세요" maxlength="100">
                        ...
                        <div class="card card-plain">
                            <div class="card-body">
                                <div class="form-check">
                                    <input type="radio" id="allTime" class="form-check-input" name="period" data-target="#moongcledeal_period" data-name="상시" checked>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            <div class="card-body">
                                <div class="form-check">
                                    <input type="radio" id="possibleAllTime" class="form-check-input" name="possible" data-target="#moongcledeal_possible_view" data-name="상시" checked>
                    ...
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            <div class="card-body">
                                ...
                                <div class="form-check">
                                    <input type="radio" id="all" class="form-check-input" name="target" data-target="#moongcledeal_target" data-name="전체 발송 (수요 매칭 고객 + 탐색 고객)" checked>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            <div class="card-body">
                                <div class="form-check">
                                    <input type="radio" id="basic" class="form-check-input" name="notiText" data-name="뭉클 시스템에서 알아서 메시지 발송" checked>
    ...
    <script>
       ...
       // 투숙 가능일
        $(document).ready(function() {
            // 기본적으로 "상시" 값이 선택되어 있도록 설정
            const defaultPossiblePeriod = '상시';
            ...
            if (defaultPossiblePeriodTarget.length) {
                ...
                allReflectionsWrap.text("상시").show();
            } 
    ...
    <script>
        ...
        document.getElementById('submitForm').addEventListener('click', async function(e) {
            ...
            try {
                ...
                if (response.ok) {                   
                    alert('신규 뭉클딜이 생성되었습니다.');
                    loading.style.display = 'flex'; 
                    window.location.href = '/manage/moongcleoffers';
                } else {
                    alert(result?.error || '뭉클딜 생성 중 문제가 발생했습니다.');
                }
            } catch (error) {
                console.error('뭉클딜 생성 중 오류 발생:', error);
                alert('뭉클딜 생성 중 오류가 발생했습니다.');
            }
        });
    </script>
