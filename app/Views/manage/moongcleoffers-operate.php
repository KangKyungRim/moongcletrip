            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-14 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">(관리자 전용) 뭉클딜 관리</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">(관리자 전용) 뭉클딜 관리</h6>
                </nav>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header pb-0 mb-5">
                            <div class="d-lg-flex justify-content-between align-items-center">
                                <div>
                                    <h5 class="mb-0">(관리자 전용) 뭉클딜 관리</h5>
                                </div>
                            ...
                            <table class="table align-items-center" style="table-layout: fixed;">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 cursor-pointer" onclick="updateSorting('partnerName')">숙소명
                                            <span class="d-inline-block sortIcon ms-2" style="position: relative; z-index: 1000; width: 10%; height: 16px;" data-column="partnerName"></span>
                                        </th>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">대표 태그</th> 
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">매력도 지수</th>
                                ...
                                <tbody id="moongcleoffersAccordion">
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-weight-bold">
                                                    <span class="my-2 text-xs">
                                                        ...
                                                        <?php if ($start_date === null || $end_date === null) : ?>                                                            
                                                            <span class="badge badge-info text-xs" style="background-color: rgb(231 251 255); word-wrap: break-word; word-break: break-word; white-space: normal;">상시</span>
                                                        <?php elseif ($today < $start_date) : ?>
                                                            <span class="badge badge-primary text-xs" style="background-color: rgb(255 232 250); word-wrap: break-word; word-break: break-word; white-space: normal; line-height: 1.4;"><?= date('Y-m-d', $start_date); ?><br>발송 예정</span>
                                                        <?php elseif ($today >= $start_date && $today <= $end_date) : ?> 
                                                            <span class="badge badge-success text-xs" style="background-color: rgb(237 255 215); word-wrap: break-word; word-break: break-word; white-space: normal;">발송 중</span>
                                                        <?php elseif ($today > $end_date) : ?>
                                                            <?php if ($moongcleoffer->stay_moongcleoffer_status === "enabled") : ?>
                                                                <span class="badge badge-secondary text-xs" style="background-color: rgb(245 245 245); word-wrap: break-word; word-break: break-word; white-space: normal;">종료</span>
                                                            <?php elseif ($moongcleoffer->stay_moongcleoffer_status === "disabled") : ?>
                                                                <span class="badge badge-secondary text-xs" style="background-color: rgb(245 245 245); word-wrap: break-word; word-break: break-word; white-space: normal;">중지됨</span>
                                                            <?php endif; ?>        
                                                        <?php endif; ?>
                                                    </span>
                                                </td>
                                                <td class="font-weight-bold">
                                                    <span class="my-2 text-xs"  style="word-wrap: break-word; word-break: break-word; white-space: normal;">
                                                        <?php if ($moongcleoffer->stay_start_date === null || $moongcleoffer->stay_end_date === null) : ?>
                                                            상시
                                                        <?php else : ?>
                                                            <?= date('Y-m-d', strtotime($moongcleoffer->stay_start_date)); ?> <br>~ <?= date('Y-m-d', strtotime($moongcleoffer->stay_end_date)); ?>
                                                        <?php endif; ?>
                                                    </span>
                                                    </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div 
                                                        ...
                                                        style="white-space: normal; word-wrap: keep-all;">
                                                        <?php 
                                                            if (empty($moongcleoffer->curated_tag_list)) {
                                                                echo '-';
                                                            } else {
                                                                $tag_count = count($moongcleoffer->curated_tag_list);
                                                                echo '<span>';
                                                                if ($tag_count > 1) {
                                                                    echo '<span class="ellipsis" style="display: block;">';

                                                                    $first_tag = $moongcleoffer->curated_tag_list[0]['tag_name'];
                                                                    if ($first_tag === "커플") {
                                                                        $first_tag = "연인과";
                                                                    }
                                                                    echo '#' . $first_tag . '... ' . '</span> ';
                                                                } else {
                                                                    foreach ($moongcleoffer->curated_tag_list as $tag) {
                                                                        if ($tag['tag_name'] === "커플") {
                                                                            $tag['tag_name'] = "연인과";
                                                                        }
                                                                        echo '<span style="display:block;">#' . $tag['tag_name'] . '</span>';
                                                ...
                                                <td class="font-weight-bold my-2 text-xs">
                                                    <span class="d-inline-block" style="word-wrap: break-word; word-break: break-word; white-space: normal;">
                                                        <?= $moongcleoffer->attractive; ?>점
                                                    </span>                                                                                                            
                                                </td>
                                                <td class="font-weight-bold">
                                                    <div class="cursor-pointer">
                                                        <a href="/manage/moongcleoffers/operate/edit?stayMoongcleofferIdx=<?= $moongcleoffer->stay_moongcleoffer_idx ?>">
                                                ...
                                                <td colspan="14" class="p-0 border-0">
                                                    <div class="text-sm p-4 collapse" id="moreTags<?= $moongcleoffer->stay_moongcleoffer_idx ?>" data-bs-parent="#moongcleoffersAccordion" style="border-top: 1px solid rgb(233, 236, 239);">
                                                        <div class="p-5 rounded-3 text-start" style="background: #F5F5F5;">
                                                            ...
                                                            <div>
                                                                <h4 class="text-sm" style="color:#3A416F;">대표 태그</h4>
                                                                <div class="d-flex flex-wrap gap-1 align-items-center">
                                                                    <?php if (!empty($moongcleoffer->curated_tag_list)) : ?>    
                                                                        <?php foreach ($moongcleoffer->curated_tag_list as $curated_tag) : ?>
                                                                            <span class="d-inline-block text-xs" style="color: #344767;">#<?= $curated_tag->tag_name; ?></span>
                                                                        <?php endforeach; ?>
                                                                    <?php else : ?>
                                                                        <span class="d-inline-block text-xs" style="color: #344767;">-</span>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>  
                                                        </div>
                                    ...
                                    <?php else : ?>
                                        <tr>
                                            <td colspan="14" class="text-center py-10">등록된 뭉클딜이 없습니다.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                    ...
                    try {
                        ...
                        if (response.ok) {
                            if (status === 'enabled') {
                                ...
                                window.location.href = `/manage/moongcleoffers/operate/edit?stayMoongcleofferIdx=${moongcleofferIdx}`;
                            } else {
