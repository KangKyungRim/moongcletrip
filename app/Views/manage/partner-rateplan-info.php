    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
                            ...
                            <div class="card card-body p-5">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex justify-content-end align-items-center">
                                        <button type="button" id="editForm" name="editForm" class="btn btn-light m-0" onclick="location.href='/manage/partner-rateplan-info-edit?rateplanIdx=<?= $rateplan->rateplan_idx ?>'">수정하기</button>
                                    </div>
                                </div>
            ...
            <div class="d-flex justify-content-center mt-4">
                <button type="button" id="cancelForm" class="btn btn-light m-0" onclick="location.href='/manage/partner-rateplan-list'">뒤로</button>
            </div>
