...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <?php if ($publish['room']->review_status !== "first_review") : ?>
                                            <div class="d-flex justify-content-end align-items-center">
                                                <button type="button" id="editForm_publish" name="editForm" class="btn btn-light m-0" onclick="location.href='/manage/partner-room-info-edit?roomIdx=<?= $publish['room']['room_idx']; ?>'">수정하기</button>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                        ...
                        <div class="col-12 mx-auto">
                            <div class="card card-body p-5">
                                <div class="mb-0 d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex justify-content-end align-items-center">
                                        <button type="button" id="editForm_draft" name="editForm" class="btn btn-light m-0" onclick="location.href='/manage/partner-room-info-edit?roomIdx=<?= $draft['room']['room_idx']; ?>'">수정하기</button>
        ...
        <div class="d-flex justify-content-center mt-4">
            <button type="button" id="cancelForm" name="cancelForm" class="btn btn-light m-0" onclick="location.href='/manage/partner-room-list'">뒤로</button>
        </div>
