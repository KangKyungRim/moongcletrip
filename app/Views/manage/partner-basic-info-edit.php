                                    ...
                                    <div class="multisteps-form__content">
                                       ...
                                       <hr class="horizontal dark my-3">
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col text-xs d-flex flex-wrap" style="max-width: 80%;">
                                                <?php foreach ($data['tags']['searchBadgeTags'] as $key => $searchBadge) : ?>
                                                    <div class="form-check" style="flex: 0 0 15%; min-width: 140px;">
                                                        <input
                                                            class="form-check-input"
                                                            type="checkbox"
                                                            value="<?= htmlspecialchars($searchBadge['tag_name']) ?>"
                                                            id="searchBadge-<?= htmlspecialchars($searchBadge['tag_name']) ?>"
                                                            name="searchBadge[]"
                                                            <?= in_array($searchBadge['tag_name'], $selectedSearchBadges) ? 'checked' : '' ?>
                                                        >
                                                        <label class="custom-control-label" for="searchBadge-<?= htmlspecialchars($searchBadge['tag_name']) ?>">
                                                            <?= htmlspecialchars($searchBadge['tag_name']) ?>
                                                        </label>
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
