...
<!-- Head -->
<?php include $_SERVER['DOCUMENT_ROOT'] . "/../app/Views/parner/blocks/head.php"; ?>
<!-- Head -->
...
<body class="error-page">
				...
				<div class="container">
					<div class="row mt-lg-0 mt-8">
						...
						<div class="col-lg-7 my-auto">
							<img class="w-100 fadeIn1 fadeInBottom" src="/assets/parner/images/illustrations/error-500.png" alt="500-error">
						</div>
					</div>
				</div>
			</section>
	...
	<!--   Core JS Files   -->
	<script src="/assets/parner/js/core/popper.min.js"></script>
	<script src="/assets/parner/js/core/bootstrap.min.js"></script>
	<script src="/assets/parner/js/plugins/perfect-scrollbar.min.js"></script>
	<script src="/assets/parner/js/plugins/smooth-scrollbar.min.js"></script>
	<script src="/assets/parner/js/plugins/choices.min.js"></script>
	<script src="/assets/parner/js/plugins/quill.min.js"></script>
	<script src="/assets/parner/js/plugins/flatpickr.min.js"></script>
