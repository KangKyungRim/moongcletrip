            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-14 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">신규 파트너 생성</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">신규 파트너 생성</h6>
                </nav>
        ...
        document.getElementById('submitForm').addEventListener('click', async function() {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    window.location.href = '/manage/partner-basic-info?partner_idx=' + '<?= $_GET['partner_idx']; ?>';
                } else {
