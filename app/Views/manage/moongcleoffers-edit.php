            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-14 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">뭉클딜 상세 정보 수정</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">뭉클딜 상세 정보 수정</h6>
                </nav>
                ...
                <div class="col-12 d-flex align-items-start gap-6">
                    ...
                    <div class="inputFormBox w-75">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        ...
                                        <button 
                                            ...
                                            title="다양하고 정확한 연관 태그를 선택하면 많은 고객에게 매칭됩니다. 연관되지 않은 태그를 무분별하게 선택 시에는 효과가 떨어질 수 있어요.">
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <button type="button" id="cancelForm" name="cancelForm" class="btn btn-light m-0" onclick="location.href='/manage/moongcleoffers'">취소</button>
                            <button class="btn bg-gradient-primary ms-2 mb-0 text-white submitForm" type="button" title="Save">저장하기</button>
                        </div>
                    </div>
                </div>
