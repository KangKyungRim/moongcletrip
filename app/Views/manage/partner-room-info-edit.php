...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-14 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">객실 상세 정보 수정</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">객실 상세 정보 수정</h6>
                </nav>
        ...
        <div class="container-fluid py-4">
                            ...
                            <div class="card card-body p-5">
                                ...
                                <div>
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" id="roomName" name="roomName" value="<?= $data['room']['room_name']; ?>" placeholder="객실 이름을 입력해 주세요 (최소 2자 ~ 최대 50자)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col">
                                            <textarea class="form-control" id="roomOtherNotes" name="roomOtherNotes" rows="7" placeholder="객실 정보를 입력해 주세요"><?= $data['room']['room_other_notes']; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <?php 
                                            if (isset($data['roomtype']) && is_object($data['roomtype'])) {
                                                $data['roomtype'] = json_decode(json_encode($data['roomtype']), true);
                                            }
                                            $selectedRoomtypes = isset($data['roomtype']) 
                                            ? array_map(fn($tag) => "roomtype-" . $tag, array_column($data['roomtype'], 'tag_idx')) 
                                            : [];
                                        ?>
                                            ...
                                            <div class="row">
                                                <div class="d-inline-block w-auto">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <input class="form-control mx-3" type="numebr" id="dormitory_beds" name="dormitory_beds" value="<?= $data['room']['room_bed_type']['dormitory_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <label class="custom-control-label w-50" for="single_beds">싱글 베드</label>
                                                        <input class="form-control mx-3" type="numebr" id="single_beds" name="single_beds" value="<?= $data['room']['room_bed_type']['single_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <label class="custom-control-label w-50" for="super_single_beds">슈퍼 싱글 베드</label>
                                                        <input class="form-control mx-3" type="numebr" id="super_single_beds" name="super_single_beds" value="<?= $data['room']['room_bed_type']['super_single_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <label class="custom-control-label w-50" for="semi_double_beds">세미 더블 베드</label>
                                                        <input class="form-control mx-3" type="numebr" id="semi_double_beds" name="semi_double_beds" value="<?= $data['room']['room_bed_type']['semi_double_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <label class="custom-control-label w-50" for="double_beds">더블 베드</label>
                                                        <input class="form-control mx-3" type="numebr" id="double_beds" name="double_beds" value="<?= $data['room']['room_bed_type']['double_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                </div>
                                                <div class="d-inline-block w-auto">
                                                    <div class="d-flex align-items-center">
                                                        <label class="custom-control-label w-50" for="queen_beds">퀸 베드</label>
                                                        <input class="form-control mx-3" type="numebr" id="queen_beds" name="queen_beds" value="<?= $data['room']['room_bed_type']['queen_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <label class="custom-control-label w-50" for="king_beds">킹 베드</label>
                                                        <input class="form-control mx-3" type="numebr" id="king_beds" name="king_beds" value="<?= $data['room']['room_bed_type']['king_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <label class="custom-control-label w-50" for="hollywood_twin_beds">할리우드 베드</label>
                                                        <input class="form-control mx-3" type="numebr" id="hollywood_twin_beds" name="hollywood_twin_beds" value="<?= $data['room']['room_bed_type']['hollywood_twin_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <label class="custom-control-label w-50" for="double_story_beds">이층 침대</label>
                                                        <input class="form-control mx-3" type="numebr" id="double_story_beds" name="double_story_beds" value="<?= $data['room']['room_bed_type']['double_story_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <label class="custom-control-label w-50" for="bunk_beds">벙크 베드</label>
                                                        <input class="form-control mx-3" type="numebr" id="bunk_beds" name="bunk_beds" value="<?= $data['room']['room_bed_type']['bunk_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                </div>
                                                <div class="d-inline-block w-auto">
                                                    <div class="d-flex align-items-center">
                                                        <label class="custom-control-label w-50" for="rollaway_beds">간이 침대</label>
                                                        <input class="form-control mx-3" type="numebr" id="rollaway_beds" name="rollaway_beds" value="<?= $data['room']['room_bed_type']['rollaway_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <label class="custom-control-label w-50" for="futon_beds">요이불 세트</label>
                                                        <input class="form-control mx-3" type="numebr" id="futon_beds" name="futon_beds" value="<?= $data['room']['room_bed_type']['futon_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <label class="custom-control-label w-50" for="capsule_beds">캡슐 침대</label>
                                                        <input class="form-control mx-3" type="numebr" id="capsule_beds" name="capsule_beds" value="<?= $data['room']['room_bed_type']['capsule_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <label class="custom-control-label w-50" for="sofa_beds">소파 베드</label>
                                                        <input class="form-control mx-3" type="numebr" id="sofa_beds" name="sofa_beds" value="<?= $data['room']['room_bed_type']['sofa_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                    <div class="d-flex align-items-center mt-3">
                                                        <label class="custom-control-label w-50" for="air_beds">에어 베드</label>
                                                        <input class="form-control mx-3" type="numebr" id="air_beds" name="air_beds" value="<?= $data['room']['room_bed_type']['air_beds']; ?>" placeholder="0" style="width:6rem;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col d-flex flex-column gap-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="mx-2">
                                                    <input type="number" class="form-control" id="roomSize" name="roomSize" value="<?= $data['room']['room_size']; ?>" placeholder="0" style="width:6rem; flex: none;">
                                                </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col d-flex flex-column gap-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="mx-2">
                                                    <input type="number" class="form-control" id="childAge" name="childAge" value="<?= $data['room']['room_child_age']; ?>" placeholder="12" aria-label="childAge" min="0"  style="width:6rem; flex: none;">
                                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="mx-2">
                                                    <input type="number" class="form-control" id="infantMonth" name="infantMonth" value="<?= $data['room']['room_tiny_month']; ?>" placeholder="36" aria-label="infantMonth" min="0"  style="width:6rem; flex: none;">
                                                </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col d-flex flex-column gap-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="mx-2">
                                                    <input type="number" class="form-control" id="standardPerson" name="standardPerson" value="<?= $data['room']['room_standard_person']; ?>" placeholder="2" aria-label="standardPerson" min="0"  style="width:6rem; flex: none;">
                                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="mx-2">
                                                    <input type="number" class="form-control" id="maxPerson" name="maxPerson" value="<?= $data['room']['room_max_person']; ?>" placeholder="4" aria-label="maxPerson" min="0"  style="width:6rem; flex: none;">
                                                </div>
                                                <div class="text-xs">명</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col d-flex flex-column gap-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="mx-2">
                                                    <input type="number" class="form-control" id="extraAdultFee" name="extraAdultFee" value="<?= $data['room']['room_adult_additional_price']; ?>" placeholder="0" aria-label="extraAdultFee" min="0"  style="width:6rem; flex: none;">
                                                </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="mx-2">
                                                    <input type="number" class="form-control" id="extraChildFee" name="extraChildFee" value="<?= $data['room']['room_child_additional_price']; ?>" placeholder="0" aria-label="extraChildFee" min="0"  style="width:6rem; flex: none;">
                                                </div>
                                                <div class="text-xs">원</div>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="mx-2">
                                                    <input type="number" class="form-control" id="extraInfantFee" name="extraInfantFee" value="<?= $data['room']['room_tiny_additional_price']; ?>" placeholder="0" aria-label="extraInfantFee" min="0"  style="width:6rem; flex: none;">
                                                </div>
                                                <div class="text-xs">원</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <?php 
                                            if (isset($data['view']) && is_object($data['view'])) {
                                                $data['view'] = json_decode(json_encode($data['view']), true);
                                            }
                                            $selectedViews = isset($data['view']) 
                                            ? array_map(fn($tag) => "view-" . $tag, array_column($data['view'], 'tag_idx')) 
                                            : [];
                                        ?>
                                        <div class="col text-xs d-flex flex-wrap" style="max-width: 80%;">
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <?php 
                                            if (isset($data['amenity']) && is_object($data['amenity'])) {
                                                $data['amenity'] = json_decode(json_encode($data['amenity']), true);
                                            }
                                            $selectedAmenities = isset($data['amenity']) 
                                            ? array_map(fn($tag) => "amenity-" . $tag, array_column($data['amenity'], 'tag_idx')) 
                                            : [];
                                        ?>
                                        <div class="col text-xs d-flex flex-wrap" style="max-width: 80%;">
            ...
            <div class="d-flex justify-content-center mt-4">
                <button type="button" id="cancelForm" name="cancelForm" class="btn btn-light m-0" onclick="location.href='/manage/partner-room-list'">취소</button>
    ...
    <script>
        document.getElementById('submitForm').addEventListener('click', async function() {
            ...
            const roomIdx = Number(<?php echo json_encode($data['room']['room_idx']); ?>);

            const formData = {
                partnerIdx: selectedPartnerIdx, // index
                roomIdx: roomIdx, // roomIdx
            ...
            try {
                // 서버로 POST 요청
                const response = await fetch('/api/partner/room/edit', {
                    method: 'POST',
                    headers: {
                ...
                if (response.ok) {
                    ...
                    window.location.href = '/manage/partner-room-info?roomIdx=' + '<?= $_GET['roomIdx']; ?>';
                } else {
        ...
        var roomBasicImageDropzone = new Dropzone(roomBasicImage, {
            ...
            init: function() {
                ...
                myDropzone.on("removedfile", function(file) {
                    if (roomBasicImageMeta.length === 1) {
                        alert("객실 이미지는 최소 1개 이상 유지해야 합니다.");
                        // 마지막 이미지이므로 다시 추가
