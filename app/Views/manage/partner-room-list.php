                            ...
                            <div class="d-lg-flex justify-content-between align-items-center">
                                ...
                                <div class="right">
                                    ...
                                    <div class="d-inline-block">
                                        <a href="/manage/partner-room-info-create" class="btn btn-primary btn-sm mb-0" style="padding: 0.75rem 2rem;">+&nbsp; 신규 객실 생성</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr data-room-idx="<?= $room->room_idx; ?>">
                                                ...
                                                <td>
                                                    <div class="d-flex px-2">
                                                        <div class="my-auto">
                                                            <a href="/manage/partner-room-info?roomIdx=<?= $room->room_idx; ?>">
                                                                <div class="d-flex">
                                                ...
                                                <td class="align-middle">
                                                    <div class="cursor-pointer">
                                                        <a href="/manage/partner-room-info-edit?roomIdx=<?= $room->room_idx; ?>">
