...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-14 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">부대 시설 등록</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">부대 시설 등록</h6>
                </nav>
        ...
        <div class="container-fluid py-4">
                            ...
                            <div class="card card-body p-5">
                                ...
                                <div>
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="facilityName" name="facilityName" placeholder="이름을 입력해 주세요.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="facilityName" class="form-control-label col-sm-2">시설 정보</label>
                                        <div class="col-md-6">
                                            <div class="form-control dropzone mb-3" id="facilitiesBasicImage"></div>
                                            <textarea class="form-control" id="facilityInfo" name="facilityInfo" rows="7" placeholder="설명을 입력해 주세요."></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="facilitySubInfo" class="form-control-label col-sm-2">추가 정보</label>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="facilitySubInfo" name="facilitySubInfo" placeholder="간단한 추가 정보를 입력해 주세요. (예시 : 오픈 시간, 위치 등)">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="d-flex justify-content-center mt-4">
                <button type="button" id="cancelForm" name="cancelForm" class="btn btn-light m-0" onclick="location.href='/manage/partner-facilities'">취소</button>
        ...
        var facilitiesBasicImageDropzone = new Dropzone(facilitiesBasicImage, {
            ...
            init: function() {
                ...
                myDropzone.on("success", function(file, response) {
                    ...
                    facilitiesBasicImageMeta.push(parsedResponse.uploaded_images[0]);
                ...
                myDropzone.on("removedfile", function(file) {
                    ...
                    const index = facilitiesBasicImageMeta.findIndex(img => img.image_origin_name === filename);
                    if (index !== -1) {
                        facilitiesBasicImageMeta.splice(index, 1);
                    }
                    facilitiesBasicImageMetaInput();
                });
    ...
    <script>
        ...
        document.getElementById('submitForm').addEventListener('click', async function() {
            ...
            try {
                const response = await fetch('/api/partner/create-facility-detail', {
                    method: 'POST',
                    headers: {
                ...
                if (response.ok) {
                    alert('부대 시설 등록이 완료되었습니다.');
                    loading.style.display = 'flex'; 
                    window.location.href = '/manage/partner-facilities';
                } else {
