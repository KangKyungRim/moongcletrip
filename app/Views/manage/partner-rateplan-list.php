                        ...
                        <div class="card-header pb-0 mb-5">
                            <div class="d-lg-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="/manage/partner-rateplan-info-create" class="btn btn-primary btn-sm mb-0">+&nbsp; 신규 요금제 생성</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <?php foreach ($rateplans as $rateplan) : ?>
                                        <tr>
                                            <td class="font-weight-bold partner-list">
                                                <a href="/manage/partner-rateplan-info?rateplanIdx=<?= $rateplan->rateplan_idx ?>">
                                            ...
                                            <td class="font-weight-bold w-10">
                                                <div class="cursor-pointer">
                                                    <a href="/manage/partner-rateplan-info-edit?rateplanIdx=<?= $rateplan->rateplan_idx ?>">
