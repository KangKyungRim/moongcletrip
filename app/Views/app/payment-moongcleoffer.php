				...
				<div id="reservationUser" class="payment__list reservation-collapse">
					...
					<div class="input__wrap">
						<div class="input__con">
							...
							<input id="reservationName" type="text" class="input-default" placeholder="성함을 입력해 주세요" value="<?= !empty($user->reservation_name) ? $user->reservation_name : ''; ?>">
						</div>
						<div class="input__con">
							<label for="reservationTel" class="input-label">전화번호<span class="required-indicator">*</span></label>
							<input id="reservationTel" type="tel" class="input-default" placeholder="- 는 제외하고 숫자만 입력해 주세요" value="<?= !empty($user->reservation_phone) ? $user->reservation_phone : ''; ?>">
						</div>
						<div class="input__con">
							<label for="reservationEmail" class="input-label">이메일<span class="required-indicator">*</span></label>
							<input id="reservationEmail" type="email" class="input-default" placeholder="이메일을 입력해 주세요" value="<?= !empty($user->reservation_email) ? $user->reservation_email : ''; ?>">
						</div>
					</div>
				</div>
				<div id="visitUser" class="payment__list">
					...
					<div class="input__wrap">
						<div class="input__con">
							...
							<input id="visitName" type="text" class="input-default" placeholder="성함을 입력해 주세요">
						</div>
						<div class="input__con">
							<label for="visitTel" class="input-label">전화번호<span class="required-indicator">*</span></label>
							<input id="visitTel" type="tel" class="input-default" placeholder="- 는 제외하고 숫자만 입력해 주세요">
						</div>
						<div class="input__con">
							<label for="visitEmail" class="input-label">이메일<span class="required-indicator">*</span></label>
							<input id="visitEmail" type="email" class="input-default" placeholder="이메일을 입력해 주세요">
						</div>
		...
		document.getElementById('paymentNext').addEventListener('click', async function(event) {
			...
			if (valid) {
				try {
					...
					formData.append(`paymentItems[0][product_idx]`, partner.moongcleoffer_idx);
					formData.append(`paymentItems[0][product_category]`, 'stay');
					formData.append(`paymentItems[0][product_type]`, 'moongcledeal');
					...
					formData.append(`paymentItems[0][product_benefits]`, partner.benefits);
					...
					formData.append(`paymentItems[0][item_origin_sale_price]`, partner.total_origin_sale_price);
