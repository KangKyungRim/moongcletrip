        ...
        <div class="container__wrap mkcle-create__wrap">
            ...
            <section class="layout__wrap pd-big">
                ...
                <div class="type-gray" style="padding: 1rem 0 2rem;">
                    ...
                    <!-- <ul>
                        <?php foreach ($selected['days'] as $row) : ?>
                            <?php if (!empty($row['dates'])) : ?>
                                <li class="active"><a><span class="num">0</span><span class="tag">#<?= $row['dates']; ?></span></a></li>
                            <?php endif; ?>
                        <?php endforeach; ?>
                        <?php if (!empty($selected['personnel'])) : ?>
                            <li class="active"><a><span class="num">0</span><span class="tag">#<?= $selected['personnel']; ?>명</span></a></li>
                        <?php endif; ?>
                        <?php if (!empty($selected['companion'])) : ?>
                            <li class="active"><a><span class="num">0</span><span class="tag">#<?= $selected['companion']['tag_name']; ?></span></a></li>
                        <?php endif; ?>
                        <?php if (!empty($selected['city'])) : ?>
                            <li class="active"><a><span class="num">0</span><span class="tag">#<?= $selected['city']['tag_name']; ?></span></a></li>
                        <?php endif; ?>
                    </ul> -->
                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById("confirmButton").addEventListener("click", async function(e) {
            ...
            try {
                let moongcledealIdx = <?= $_GET['moongcledeal_idx'] ?>;
