    ...
    <div id="mobileWrap">
        <header class="header__wrap">
            <div class="header__inner">
                <button class="btn-back fnOpenPop" data-name="alertBack"><span class="blind">뒤로가기</span></button>
                <p class="process-txt"><span>1단계</span> 남았어요</p>
            </div>
        </header>
        ...
        <div class="container__wrap mkcle-create__wrap">
            ...
            <div class="progress__wrap fnStickyTop">
                <div class="progress__inner" style="width:60%;"></div>
            </div>
            <!-- //프로그레스바 -->

            <section class="layout__wrap bg-gray">
                <div class="tit__wrap">
                    <h2 class="ft-xxxl">어떤 좋은 숙소를 찾아드릴까요?</h2>
                </div>
                ...
                <div class="box-white__list accordion__wrap">
                    ...
                    <!-- 총 예산은 얼마인가요? -->
                    <!-- <div class="box-white__wrap accordion__list active">
                        <div id="" class="accordion__tit active">
                            <div class="tit__wrap">
                                <p class="ft-default">총 예산은 얼마인가요?</p>
                            </div>
                            <button id="" class="btn-sm__line">미정</button>

                            <p id="" class="txt-status__complete hidden">선택 완료!</p>
                        </div>

                        <div class="accordion__con" style="display: block;">
                            <div class="select_budget__wrap">
                                <div id="priceBox">
                                    ...
                                    <div class="price-filter">
                                        ...
                                        <div class="price-range">
                                            ...
                                            <span id="max-price">3,000,000만원</span>
                                        </div>
                                    </div>

                                    <div class="input_budget">
                                        <p class="tit">직접 입력하기</p>
                                        <div class="input__wrap">
                                            <input id="minPriceInput" type="number" placeholder="예산을 직접 입력해 주세요">
                                            <span>원</span>
                                        </div>  
                                    </div>
                                </div>
                            ...
                            <div class="btn__wrap mt30">
                                <button id="selectBudgetUndefined" class="btn-full__line">미정</button>
                                <button id="selectBudget" class="btn-full__black disabled" disabled>선택</button>
                            </div>
                        </div>
                    </div> -->
                    <!-- // 총 예산은 얼마인가요? -->
                    ...
                    <div class="box-white__wrap">
                        ...
                        <div class="tab__wrap tab-switch__wrap">
                            ...
                            <div class="tab-contents__wrap">
                                <!-- 랜덤추천 탭 콘텐츠 -->
                                <div class="tab-contents active">
                                    <div id="selectedRandomTags" class="select__wrap type-img favorite-tag">
                                        <ul>
                                ...
                                <div class="tab-contents">
                                    <div class="custom-list__wrap">
                                        <ul>
                                            ...
                                            <!-- <li id="travelTaste" class="custom-list">
                                                <div class="flex-between">
                                                    <p class="ft-default">여행 취향 <span data-section="travelTaste"></span></p>
                                                    <a class="fnOpenPop" data-name="popupTravelTaste"><i class="ico ico-plus__small"></i></a>
                                                </div>
                                            </li>
                                            <li id="event" class="custom-list">
                                                <div class="flex-between">
                                                    <p class="ft-default">이벤트 <span data-section="event"></span></p>
                                                    <a class="fnOpenPop" data-name="popupEvent"><i class="ico ico-plus__small"></i></a>
                                                </div>
                                            </li>
                                            <li id="stayTaste" class="custom-list">
                                                <div class="flex-between">
                                                    <p class="ft-default">숙박 취향 <span data-section="stayTaste"></span></p>
                                                    <a class="fnOpenPop" data-name="popupStayTaste"><i class="ico ico-plus__small"></i></a>
                                                </div>
                                            </li>
                                            <li id="stayType" class="custom-list">
                                                <div class="flex-between">
                                                    <p class="ft-default">선호 숙박 유형 <span data-section="stayType"></span></p>
                                                    <a class="fnOpenPop" data-name="popupStayType"><i class="ico ico-plus__small"></i></a>
                                                </div>
                                            </li>
                                            <li id="petFacility" class="custom-list">
                                                <div class="flex-between">
                                                    <p class="ft-default">반려 동물 <span data-section="petFacility"></span></p>
                                                    <a class="fnOpenPop" data-name="popupPetFacility"><i class="ico ico-plus__small"></i></a>
                                                </div>
                                            </li>
                                            <li id="stayBrand" class="custom-list">
                                                <div class="flex-between">
                                                    <p class="ft-default">선호 브랜드 <span data-section="stayBrand"></span></p>
                                                    <a class="fnOpenPop" data-name="popupStayBrand"><i class="ico ico-plus__small"></i></a>
                                                </div>
                                            </li> -->
                                        </ul>
                                    </div>
    ...
    <script>
       ...
       // 크기 (size) 선택 처리
        ...
        gotoNextStepButton.addEventListener("click", async () => {
            ...
            try {
                let url = '<?= !empty($_GET['moongcledeal_idx']) ? '/api/moongcledeal/update' : '/api/moongcledeal/store' ?>';
                let moongcledealIdx = <?= json_encode(!empty($_GET['moongcledeal_idx']) ? $_GET['moongcledeal_idx'] : null) ?>;
                ...
                if (result.moongcledealIdx) {
                    window.location.href = `/moongcledeal/create/03?moongcledeal_idx=${result.moongcledealIdx}`;
                } else {
