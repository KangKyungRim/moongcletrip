                                  ...
                                  <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <!-- <?php if ($publish['partner']->partner_address1 !== null) : ; ?>
                                            <div class="d-flex justify-content-end align-items-center">
                                                <button type="button" id="editForm_publish" name="editForm" class="btn btn-light m-0" onclick="location.href='/partner/partner-basic-info-edit'">수정하기</button>
                                            </div>
                                        <?php endif; ?>  -->
                                    </div>
                          ...
                          <div class="col-12 mx-auto">
                              <div class="card card-body p-5">
                                  <div class="mb-0 d-flex justify-content-between align-items-center">
                                      <h6>심사 중인 정보</h6>
                                      <div class="d-flex justify-content-end align-items-center">
                                        <!-- <button type="button" id="editForm_draft" name="editForm" class="btn btn-light m-0"  onclick="location.href='/partner/partner-basic-info-edit'">수정하기</button>
