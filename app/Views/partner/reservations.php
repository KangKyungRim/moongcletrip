                            ...
                            <div class="d-inline-flex gap-2 align-items-center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                                        <li>
                                            <a class="dropdown-item" href="/partner/reservations">
                                                전체보기
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="/partner/reservations?perPage=20">
                                                20개씩 보기
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="/partner/reservations?perPage=50">
                                                50개씩 보기
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="/partner/reservations?perPage=100">
                                                100개씩 보기
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="/partner/reservations?perPage=500">
                                                500개씩 보기
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="/partner/reservations?perPage=1000">
                                                1,000개씩 보기
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <button class="btn btn-icon btn-outline-dark ms-2 export mb-0" data-type="csv" type="button" onclick="downloadCSV()">
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-weight-bold text-center">
                                                    <span class="my-2 text-xs">
                                                        <?php if ($reservation->payment_status == 'canceled') : ?>
                                                ...
                                                <td class="text-xs font-weight-bold text-center">
                                                    <div class="d-flex align-items-center">
                                                        <?php if ($reservation->payment_status == 'paid') : ?>
                                                            ...
                                                            <span>결제완료</span>
                                                        <?php elseif ($reservation->payment_status == 'canceled') : ?>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="form-group row align-items-center mb-0">
                                                                        <div class="row col align-items-center">
                                                                            <input class="form-control w-100 code_input" type="text" id="reservation_confirmed_code" value="<?= $reservation->reservation_confirmed_code; ?>" placeholder="예약 확정 번호를 입력해 주세요" data-payment-idx="<?= $reservation->payment_idx; ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
