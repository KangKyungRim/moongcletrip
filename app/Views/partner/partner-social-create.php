            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Pages</a></li>
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">뭉클맘들의 소셜 후기 등록</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">뭉클맘들의 소셜 후기 등록</h6>
                </nav>
                            ...
                            <div class="card card-body p-5">
                                ...
                                <div>
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" id="blodName" name="blodName" placeholder="블로그 이름을 입력해 주세요.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" id="reviewName" name="reviewName" placeholder="리뷰 제목을 입력해 주세요.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" id="reviewLink" name="reviewLink" placeholder="링크 입력해 주세요.">
                                        </div>
                                    </div>
                                </div>
                            </div>
