                        ...
                        <div class="card-header pb-0 mb-5">
                            <div class="d-lg-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="/partner/partner-facilities-create" class="btn btn-primary btn-sm mb-0">+&nbsp; 신규 생성</a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="font-weight-bold my-2 text-xs">
                                                    <div class="cursor-pointer">
                                                        <a href="/partner/partner-facilities-edit?facilityDetailIdx=<?= $partnerFacility->facility_detail_idx; ?>">
