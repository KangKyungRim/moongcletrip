...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-14 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">아이와 함께 이용 가능 서비스 & 꿀팁 등록</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">아이와 함께 이용 가능 서비스 & 꿀팁 등록</h6>
                </nav>
        ...
        <div class="container-fluid py-4">
                            ...
                            <div class="card card-body p-5">
                                ...
                                <div>
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" id="serviceName" name="serviceName" placeholder="타이틀을 입력해 주세요.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" id="serviceDescription" name="serviceDescription" placeholder="설명을 입력해 주세요.">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="d-flex justify-content-center mt-4">
                <button type="button" id="cancelForm" name="cancelForm" class="btn btn-light m-0" onclick="location.href='/partner/partner-service'">취소</button>
    ...
    <script>
        ...
        document.getElementById('submitForm').addEventListener('click', async function() {
            ...
            try {
                const response = await fetch('/api/partner/create-service-detail', {
                    method: 'POST',
                    headers: {
                ...
                if (response.ok) {
                    ...
                    window.location.href = '/partner/partner-service';
                } else {
