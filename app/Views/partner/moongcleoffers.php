                        ...
                        <div class="card-header pb-0 mb-5">
                            <div class="d-lg-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="/partner/moongcleoffers/create" class="btn btn-primary btn-sm mb-0">+&nbsp; 신규 뭉클딜 생성</a>
                                </div>
                            </div>
                        </div>
                    ...
                    try {
                        ...
                        if (response.ok) {
                            if (status === 'enabled') {
                                ...
                                window.location.href = `/partner/moongcleoffers/edit?stayMoongcleofferIdx=${moongcleofferIdx}`;
                            } else {
