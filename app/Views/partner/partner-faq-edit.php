            ...
            <div class="row">
                <div class="col-12 mx-auto">
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        <button type="button" id="cancelForm" name="cancelForm" class="btn btn-light m-0" onclick="location.href='/partner/partner-faq'">취소</button>
            ...
            document.getElementById('submitForm').addEventListener('click', async function() {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        window.location.href = '/partner/partner-faq';
                    } else {
