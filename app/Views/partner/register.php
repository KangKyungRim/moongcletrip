    ...
    <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4">
        <div class="container">
            <div class="sidenav-header sidenav_header_line_height">
                <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="/partner/dashboard">
            ...
            <div class="collapse navbar-collapse" id="navigation">
                <ul class="navbar-nav mx-auto ms-xl-auto me-xl-7">
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center me-2 active" aria-current="page" href="/partner/dashboard">
                            <i class="fa fa-chart-pie opacity-6 me-1"></i>
                            뭉클트립은
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link me-2" href="/partner/register">
                            <i class="fas fa-user-circle opacity-6  me-1"></i>
                            파트너 가입하기
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link me-2" href="/partner/login">
    ...
    <script>
        document.getElementById('register-form').addEventListener('submit', async function(e) {
            ...
            if (response.ok) {
                ...
                window.location.href = '/partner/login'; // 로그인 페이지로 이동
            } else {
                alert('회원가입에 실패하였습니다.');
            }
        });
