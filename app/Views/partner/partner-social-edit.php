...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Pages</a></li>
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">뭉클맘들의 소셜 후기 수정</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">뭉클맘들의 소셜 후기 수정</h6>
                </nav>
        ...
        <div class="container-fluid py-4">
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-12 mx-auto">
                            <input type="hidden" id="socialThumbnailMeta" name="socialThumbnailMeta" value="">
                            ...
                            <div class="card card-body p-5">
                                ...
                                <div>
                                    <div class="form-group row align-items-center">
                                        <label for="blodName" class="form-control-label col-sm-2">블로그 <b class="text-danger">*</b></label>
                                        <div class="col">
                                            <input type="text" class="form-control" id="blodName" name="blodName" placeholder="블로그 이름을 입력해 주세요." value="00맘의 블로그 3">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="reviewName" class="form-control-label col-sm-2">제목 <b class="text-danger">*</b></label>
                                        <div class="col">
                                            <input type="text" class="form-control" id="reviewName" name="reviewName" placeholder="리뷰 제목을 입력해 주세요." value="호텔 필수 코스 웨스턴 수영장">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="reviewwImg" class="form-control-label col-sm-2">썸네일 <b class="text-danger">*</b></label>
                                        <div class="col">
                                            <div class="form-control dropzone mb-3" id="socialThumbnail"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row align-items-center">
                                        <label for="reviewLink" class="form-control-label col-sm-2">링크 <b class="text-danger">*</b></label>
                                        <div class="col">
                                            <input type="text" class="form-control" id="reviewLink" name="reviewLink" placeholder="링크 입력해 주세요." value="https://www.naver.com/">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="d-flex justify-content-center mt-4">
                <button type="button" id="cancelForm" name="cancelForm" class="btn btn-light m-0" onclick="location.href='/partner/partner-social'">취소</button>
    ...
    <script>
        // 수정용 이미지 라이브러리로 교체 필요
        var socialThumbnailMeta = [];
        Dropzone.autoDiscover = false;
        var socialThumbnail = document.getElementById('socialThumbnail');
        var socialThumbnailDropzone = new Dropzone(socialThumbnail, {
            ...
            init: function() {
                ...
                myDropzone.on("success", function(file, response) {
                    ...
                    socialThumbnailMeta.push(parsedResponse.uploaded_images[0]);
                    socialThumbnailMetaInput();
                });
                ...
                myDropzone.on("removedfile", function(file) {
                    ...
                    const index = socialThumbnailMeta.findIndex(img => img.image_origin_name === filename);
                    if (index !== -1) {
                        socialThumbnailMeta.splice(index, 1);
                    }
                    socialThumbnailMetaInput();
                });
        ...
        function socialThumbnailMetaInput() {
            document.getElementById("socialThumbnailMeta").value = JSON.stringify(socialThumbnailMeta);
        }
    </script>
