							...
							<div class="d-lg-flex">
								...
								<div class="ms-auto my-auto mt-lg-0 mt-4">
									<div class="ms-auto my-auto">
										<a href="/partner/reward/discount-coupon/create" class="btn btn-primary btn-sm mb-0">+&nbsp; 신규 쿠폰 생성</a>
									</div>
								</div>
							</div>
						</div>
								...
								<table class="table table-flush" id="coupons-list">
									...
									<tbody>
										...
										<?php foreach ($coupons as $coupon) : ?>
											<tr>
												<td>
													<a href="/partner/reward/discount-coupon/edit?coupon_idx=<?= $coupon->coupon_idx; ?>">
