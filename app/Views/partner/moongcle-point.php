                ...
                <div class="col-12">
                            ...
                            <div class="col-12 mb-xl-0 mb-4">
                                <div class="card height-600 card-plain border">
                                    <div class="card-body d-flex flex-column justify-content-center text-center">
                                        <a href="/partner/partner-moongcle-point/update">
                    ...
                    <?php else : ?>
                        <div class="d-flex justify-content-end align-items-center">
                            <button type="button" class="btn btn-light m-0" onclick="location.href='/partner/partner-moongcle-point/update'">수정하기</button>
                        </div>
