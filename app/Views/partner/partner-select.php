                            ...
                            <div class="d-lg-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex w-40 align-items-center gap-4">
                                    <div class="ms-auto my-auto d-inline-block">
                                        <a href="/partner/partner-basic-info-create" class="btn btn-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#modal-form">+&nbsp; 신규 숙소 생성</a>
                                    </div>
                                    <!-- create form modal -->
    ...
    <script>
        ...
        function selectPartner(partnerIdx) {
            if (partnerIdx) {
                ...
                location.href= '/partner/partner-basic-info'
            } else {
                alert("숙소를 선택해 주세요.");
            }
        }
