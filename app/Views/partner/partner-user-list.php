                          ...
                          <div class="d-lg-flex justify-content-between align-items-center">
                            ...
                            <?php if ($selectedPartnerIdx > 0) : ?>
                                <div class="ms-auto my-auto d-inline-block">
                                    <a href="/partner/partner-user-create" class="btn btn-primary btn-sm mb-0">
                                        +&nbsp; 신규 관리자 생성
                                    </a> 
                                </div>
                            <?php endif; ?>
                                    ...
                                    <?php if (!empty($partnerUsers)) : ?>
                                        ...
                                        <?php foreach ($partnerUsers as $partnerUser) : ?>
                                            <tr>
                                                ...
                                                <td class="font-weight-bold">
                                                    <span class="px-1" role="button" id="editForm" name="editForm" class="btn btn-light m-0" onclick="window.location='/partner/partner-user-edit?userIdx=<?= $partnerUser->partner_user_idx; ?>'">
