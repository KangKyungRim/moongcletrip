<head>
	...
	<!-- Nucleo Icons -->
	<link href="/assets/manage/css/nucleo-icons.css" rel="stylesheet" />
	<link href="/assets/manage/css/nucleo-svg.css" rel="stylesheet" />

	<!-- Font Awesome Icons -->
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.1/css/all.min.css" integrity="sha512-5Hs3dF2AEPkpNAR7UiOHba+lRSJNeM2ECkwxUIxC1Q/FLycGTbNapWXB4tP889k5T5Ju8fs4b1P5z/iB4nMfSQ==" crossorigin="anonymous" referrerpolicy="no-referrer">
	<link href="/assets/manage/css/nucleo-svg.css" rel="stylesheet" />
	<!-- CSS Files -->
    <link id="pagestyle" href="/assets/manage/css/soft-ui-dashboard.css?v=<?= $_ENV['VERSION']; ?>" rel="stylesheet" />
    <!-- AOS evnet library -->
