...
class RoomViewController
{
    public static function roomList()
    {
        ...
        self::render('manage/partner-room-list', ['data' => $data]);
    }
    ...
    public static function roomInfo()
    {
        ...
        $data = array_merge($basicData, $appendData);
        self::render('manage/partner-room-info', ['data' => $data]);
    }
    ...
    public static function editRoomInfo()
    {
        ...
        $data = array_merge($basicData, $appendData);
        self::render('manage/partner-room-info-edit', ['data' => $data]);
    }
    ...
    public static function createRoomInfo()
    {
        ...
        self::render('manage/partner-room-info-create', ['data' => $data]);
    }
