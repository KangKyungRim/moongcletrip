...
var Msg  = {
		...
		*/
		getHtml: function(opts) {
            ...
            var html = '';
            html += '<div class="modal fade show" style="display:block; background-color: rgba(0, 0, 0, 0.3);">';
            html += '    <div class="modal-dialog modal-dialog-centered modal-m" role="document">';
            html += '        <div class="modal-content">';
            html += '            <div class="modal-header">';
            html += '                <h5 class="modal-title fs-6" id="exampleModalLabel"><@= title @></h5>';
            html += '                <button type="button" class="btn btn-mint">';
            html += '                    <span>×</span>';
            html += '                </button>';
            html += '            </div>';
            html += '            <div class="modal-body p-0">';
            html += '                <div class="card card-plain">';
            html += '                    <div class="card-body">';
            html += '                        <div class="form-group mb-0">';
            html += '                            <span class="d-block text-xs mt-2 px-1"><@= message @></span>';
            html += '                        </div>';
            html += '                    </div>';
            html += '                </div>';
            html += '            </div>';
            html += '            <div class="modal-footer justify-content-center">';
            html += '                <button class="btn btn-mint"><@= okButtonText @></button>';
            html += '			  <@ if (msgType === "confirm") { @>';
			html += '                <button class="btn btn-negative popup-close"><@= cancelButtonText @></button>';
			html += '			  <@ } @>';
            html += '            </div>';
            html += '        </div>';
            html += '    </div>';
...
function Page(pageJson, callbackId, fnCallback) {
	...
	self.html = function(pageNaviCnt, opts) {
		...
		var listClass = 'pagination justify-content-center pb-2 ';
        ...
        html += '    <a class="page-link" href="javascript:'+callback(activePrevArrow, 1)+';" aria-label="Previous">';
        html += '        <span aria-hidden="true">«</span>';
        html += '    </a>';
        html += '</li>';
        //html += '<li class="page-item ">';
        //html += '    <a class="page-link" href="javascript:'+callback(activePrevArrow, prevPage)+';" aria-label="Previous">';
        //html += '        <span aria-hidden="true">‹</span>';
        //html += '    </a>';
        //html += '</li>';

		for (var i = firstPage; i <= endPage; i++) {
		  var active = i == self.currPage ? 'active' : '';
          var activeFontColor = i == self.currPage ? 'color:#fff' : '';
          
          html += '<li class="page-item '+active+'">';
          html += '  <a class="page-link" style="'+activeFontColor+'" href="javascript:'+callback('active', i)+';">'+i+'</a>';
          html += '</li>';
		}
        
        //html += '<li class="page-item ">';
        //html += '    <a class="page-link" href="javascript:'+callback(activeNextArrow, nextPage)+';" aria-label="Next">';
        //html += '        <span aria-hidden="true">›</span>';
        //html += '    </a>';
        //html += '</li>';
        html += '<li class="page-item ">';
        html += '    <a class="page-link" href="javascript:'+callback(activeNextArrow, lastPage)+';" aria-label="Next">';
        html += '        <span aria-hidden="true">»</span>';
        html += '    </a>';
        html += '</li>';
